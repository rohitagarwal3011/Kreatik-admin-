...
public class Stock_categories extends Fragment {
     ...
     * @return A new instance of fragment Stock_categories.
     */
    // TODO: Rename and change types and number of parameters
    public static Stock_categories newInstance(String param1, String param2) {
...
//                    }
    ...
    public void set_category_list() {
        ...
        Stock_category_adapter adapter = new Stock_category_adapter(stockCategories.getCategoryList(),getContext());
        stockCategoryList.setAdapter(adapter);
        adapter.notifyDataSetChanged();
    }

    int product_selected;

    public void set_product_type(int id) throws NullPointerException {
        product_selected = id;
